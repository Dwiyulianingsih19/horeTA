...
$sqlPemilik = "SELECT * FROM pemilik_proyek";
$data = mysqli_fetch_all(mysqli_query($konek, $sqlPemilik));
        ...
        <div class="page-wrapper" style="min-height: 250px;">
			...
			<div class="container-fluid">
				...
				<div class="row">
                    <div class="col-sm-12">
						<div class="white-box">	
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tdata"><i class="fas fa-plus"></i> Tambah Pemilik Proyek</button>
						
						<div class="modal fade" id="tdata" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">Tambah Pemilik Proyek</h5>
											<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
											</button>
										</div>
										
										<form action="pemilik_fungsi.php" method="post" enctype="multipart/form-data">
											<div class="modal-body">
												<div class="form-group">
													<label for="recipient-name" class="col-form-label">Nama pemilik Proyek</label>
													<input type="text" name="nama_pemilik_proyek" class="form-control" id="recipient-name" required>
												</div>
												<div class="row">
												...
												<div class="form-group">
													...
													<input type="text" name="alamat_pemilik_proyek" class="form-control" id="recipient-name" required>
												</div>
												<div class="form-group">
											...
											<div class="modal-footer">
												...
												<button type="submit" name="tambahPemilik" class="btn btn-primary">Tambah</button>
											</div>
										</form>
									</div>
								</div>
						...
						<br><br>						
							<div class="fw-container">
								<div class="fw-body">
									...
									<div class="modal fade" id="editPemilik<?php echo $vendor[0] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
										...
										<form action="pemilik_fungsi.php" method="post" enctype="multipart/form-data">
											<div class="modal-body">
												<div class="form-group">
													<label for="recipient-name" class="col-form-label">Nama pemilik Proyek</label>
													<input type="text" name="nama_pemilik_proyek_edit" class="form-control" id="recipient-name" value="<?php echo $vendor[1]; ?>" required>
												</div>
												<div class="row">
													<div class="form-group col-md-6">
														<label for="recipient-name" class="col-form-label">No Telepon</label>
												...
												<div class="form-group">
													<label for="recipient-name" class="col-form-label">Alamat</label>
													<input type="text" name="alamat_pemilik_proyek_edit" class="form-control" id="recipient-name" value="<?php echo $vendor[3]; ?>" required>
												</div>
												<div class="form-group">
													<label for="recipient-name" class="col-form-label">Penanggung Jawab</label>
											...
											<input type="hidden" name="id_pemilik_edit" value="<?php echo $vendor[0] ?>">
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
												<button type="submit" name="editPemilik" class="btn btn-primary">Update</button>
											</div>
										</form>
									</div>
								</div>

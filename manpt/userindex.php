...
$events = mysqli_fetch_all(mysqli_query($konek, "SELECT * FROM proyek WHERE user_id ='$user_id' AND status='Berjalan' OR status='Akan Berjalan'"));
$projects = mysqli_fetch_all(mysqli_query($konek, "SELECT * FROM proyek WHERE user_id ='$user_id' AND status='Berjalan' OR status='Akan Berjalan'"));
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="white-box analytics-info">
							...
							<ul class="list-inline two-part d-flex align-items-center mb-0">
								...
								<li class="ml-auto"><span class="counter text-purple"><?php echo mysqli_num_rows(mysqli_query($konek, "SELECT * FROM proyek WHERE status='Berjalan'")); ?></span></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="white-box analytics-info">
							...
							<ul class="list-inline two-part d-flex align-items-center mb-0">
								...
								<li class="ml-auto"><span class="counter text-info"><?php echo mysqli_num_rows(mysqli_query($konek, "SELECT * FROM proyek WHERE status='Selesai'")); ?></span>
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="progress" style="height: 20px;">
									<div class="progress-bar" role="progressbar" style="width: <?php echo $persen ?>%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><?php echo $persen ?>%</div>
								</div><br>
